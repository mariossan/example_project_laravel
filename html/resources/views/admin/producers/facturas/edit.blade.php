        ...
        <div class="card">
            ...
            <div class="card-body dashboard">
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-xl-10">
                        <form action="{{ route('producers.facturas-update', [$campaign, $bill]) }}" method="POST" id="docForm" enctype="multipart/form-data">
                            @csrf
...
@section('js')
    ...
    <script>
        ...
        var csrf                = "{{ csrf_token() }}";
        var gastos_asociados    = {!! json_encode($gastos_asociados) !!};
    </script>
